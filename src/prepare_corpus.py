...
def process_files(pdf_folder=r"data\raw\corpus_pdfs", output_file="extracted_data_with_links.json", links_output_file="pdf_links.txt"): #optional - change your default folder location accordingly
